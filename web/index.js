...
var author$project$Ipc$Autonomous = {$: 'Autonomous'};
...
var author$project$Ipc$encodeMode = function (m) {
	switch (m.$) {
		case 'Teleoperated':
			return elm$json$Json$Encode$string('Teleoperated');
		case 'Autonomous':
			return elm$json$Json$Encode$string('Autonomous');
		default:
			return elm$json$Json$Encode$string('Test');
	}
};
...
var author$project$Ipc$encodeMsg = function (msg) {
	switch (msg.$) {
		case 'UpdateTeamNumber':
			var team_number = msg.a.team_number;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						elm$json$Json$Encode$string('UpdateTeamNumber')),
						_Utils_Tuple2(
						'team_number',
						elm$json$Json$Encode$int(team_number))
					]));
		case 'UpdateMode':
			var mode = msg.a.mode;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						elm$json$Json$Encode$string('UpdateMode')),
						_Utils_Tuple2(
						'mode',
						author$project$Ipc$encodeMode(mode))
					]));
		case 'UpdateEnableStatus':
			var enabled = msg.a.enabled;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						elm$json$Json$Encode$string('UpdateEnableStatus')),
						_Utils_Tuple2(
						'enabled',
						elm$json$Json$Encode$bool(enabled))
					]));
		case 'JoystickUpdate':
			var removed = msg.a.removed;
			var name = msg.a.name;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						elm$json$Json$Encode$string('JoystickUpdate')),
						_Utils_Tuple2(
						'removed',
			...
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						elm$json$Json$Encode$string('NewStdout')),
						_Utils_Tuple2(
						'message',
			...
			case 'EnableChange':
				...
				return _Utils_Tuple2(
					...
					author$project$Main$updateBackend(
						author$project$Ipc$encodeMsg(
							author$project$Ipc$UpdateEnableStatus(
								{enabled: enabled}))));
			case 'ModeChange':
				var mode = msg.a;
				return _Utils_Tuple2(
					...
					if (_n3.$ === 'Just') {
						...
						if (teamNumber > 0) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{debounce: debounce, teamNumber: team}),
								cmd);
						} else {
							return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
						}
...
var author$project$Ipc$allianceToS = function (a) {
	if (a.$ === 'Red') {
		var n = a.a;
		return 'Red ' + elm$core$String$fromInt(n);
	} else {
		var n = a.a;
		return 'Blue ' + elm$core$String$fromInt(n);
	}
};
var author$project$Ipc$modeToS = function (m) {
	switch (m.$) {
		case 'Autonomous':
			return 'Autonomous';
		case 'Teleoperated':
...
var author$project$Ui$allianceStationItem = function (alliance) {
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				author$project$Ipc$allianceToS(alliance))
			]));
};
var author$project$Ui$allianceStations = F2(
	function (n, l) {
		allianceStations:
		while (true) {
			if (!n) {
				...
				if (n > 3) {
					...
					var newL = A2(
						elm$core$List$cons,
						author$project$Ui$allianceStationItem(
							author$project$Ipc$Blue(n - 3)),
						l);
					var $temp$n = newN,
						$temp$l = newL;
					n = $temp$n;
					l = $temp$l;
					continue allianceStations;
				} else {
					var newN = n - 1;
					var newL = A2(
						elm$core$List$cons,
						author$project$Ui$allianceStationItem(
							author$project$Ipc$Red(n)),
						l);
					var $temp$n = newN,
						$temp$l = newL;
					n = $temp$n;
...
var author$project$Ui$modeItem = F2(
	function (model, mode) {
		return A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					...
					elm$html$Html$Attributes$class('list-group-item-action'),
					elm$html$Html$Attributes$class('py-1'),
					_Utils_eq(model.mode, mode) ? elm$html$Html$Attributes$class('active') : elm$html$Html$Attributes$class(''),
					elm$html$Html$Events$onClick(
					author$project$Model$ModeChange(mode))
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2(author$project$Ui$modeItem, model, author$project$Ipc$Autonomous),
										A2(author$project$Ui$modeItem, model, author$project$Ipc$Teleoperated),
										A2(author$project$Ui$modeItem, model, author$project$Ipc$Test)
									]))
							])),
						A2(
						elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(elm$html$Html$Attributes$attribute, 'aria-label', 'State Control Buttons')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Events$onClick(
												author$project$Model$EnableChange(true))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												(!model.enabled) ? elm$html$Html$Attributes$class('active') : elm$html$Html$Attributes$class(''),
												elm$html$Html$Events$onClick(
												author$project$Model$EnableChange(false))
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Disable')
											]))
									]))
							])),
						A2(
